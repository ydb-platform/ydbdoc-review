...
def load_translate_file_instructions(
    settings: Settings,
    *,
    source_lang: str = "Russian",
    target_lang: str = "English",
    ...
    return PromptBuilder.from_settings(settings).build_translate_file_instructions(
        source_lang, target_lang
    )
...
def load_placeholder_instructions(
    settings: Settings,
    *,
    source_lang: str = "Russian",
    target_lang: str = "English",
    ...
    return PromptBuilder.from_settings(settings).build_placeholder_instructions(
        source_lang, target_lang
    )


def load_masked_document_instructions(
    settings: Settings,
    *,
    source_lang: str = "Russian",
    target_lang: str = "English",
    ...
    return PromptBuilder.from_settings(settings).build_masked_document_instructions(
        source_lang, target_lang
    )
