...
> Архив выполненных или отменённых заданий. Не является нормативной спецификацией и не должен использоваться для изменения текущего конвейера. Действующий контракт: [`REQUIREMENTS_RU.md`](REQUIREMENTS_RU.md).
