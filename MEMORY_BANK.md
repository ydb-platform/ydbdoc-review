...
| 6 (incl. §6.56 doc_verify noise reduction, §6.55 cross-language placeholder alignment, §6.53 critic regression guard, §6.52 doc_verify fixup reset, §6.51 doc_verify EN render base, §6.50 doc_verify fork fallback, §6.49 action Docker/GHCR, §6.48 report comment order, §6.47 ``-rub`` assets, §6.46 YQL ``--`` comments, §6.45 prose Cyrillic, §6.44 fork nav EN baseline, §6.43–§6.41, §6.40–§6.39, §6.37–§6.36) | [03-design-decisions](docs/memory-bank/03-design-decisions.md) |
