...
> Last updated: MD031 fence spacing (§6.24), indented `<строка>` fix; §16.7 GITHUB_TOKEN CI.
...
| 6 (incl. §6.20–§6.24) | [03-design-decisions](docs/memory-bank/03-design-decisions.md) |
