...
the §25 Phase 0 restart from two empty repositories. The discarded first harness
is not a template. Five independently reviewed harness stages must produce one
signed H/S/C/D artifact before any new product implementation.
