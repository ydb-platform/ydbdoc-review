...
**Current focus:** §6.163 — remap combined RU heading slugs and explicit anchors in EN.
...
| When | What |
|------|------|
| 2026-08-26 | **§6.163** — map RU ``auto-slug-{#explicit}`` fragments to the EN explicit anchor ([ydb#50976](https://github.com/ydb-platform/ydb/pull/50976)) |
