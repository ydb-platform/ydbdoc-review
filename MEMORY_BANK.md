...
> Last updated: §6.46 YQL ``--`` fence comments; §6.45 prose Cyrillic cleanup; §6.44 fork nav EN baseline; §6.41 locale _includes; §6.39 fence comment Cyrillic; §6.38 cost reporting (₽/1K); §6.37 Wikipedia langlinks; §6.36 TOC indent;
...
| 6 (incl. §6.46 YQL ``--`` comments, §6.45 prose Cyrillic, §6.44 fork nav EN baseline, §6.43–§6.41, §6.40–§6.39, §6.37–§6.36) | [03-design-decisions](docs/memory-bank/03-design-decisions.md) |
