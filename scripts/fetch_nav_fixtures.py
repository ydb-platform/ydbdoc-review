...
CASES: dict[str, dict] = {
    "case_45181": {
        ...
        "files": [
            ...
            ("ydb/docs/ru/core/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/toc_i.yaml", "main"),
            ...
            ("ydb/docs/ru/core/reference/embedded-ui/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/integrations/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ydb-cli/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/languages-and-apis/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ai/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/kafka-api/toc_p.yaml", "main"),
            ...
            ("ydb/docs/ru/core/reference/configuration/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/observability/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ydb-dstool/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ydbops/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/docker/toc_p.yaml", "main"),
            (
    ...
    "case_43997": {
        "description": "Source PR #43997 — Java SDK recipe snippets; no cross-section scope",
        "source_pr": 43997,
        "head_sha": "ad5aae770b0602ff84e9b01cea79990a58ad8884",
        "base_ref": "main",
        "pr_diff_ru": [
        ...
        "en_present_at_base": [
            ...
            "ydb/docs/en/core/recipes/ydb-sdk/toc_p.yaml",
            "ydb/docs/en/core/reference/toc_p.yaml",
            "ydb/docs/en/core/reference/ydb-sdk/toc_p.yaml",
            "ydb/docs/en/core/reference/ydb-sdk/coordination.md",
            "ydb/docs/en/core/reference/ydb-sdk/observability/logging/logging.md",
            "ydb/docs/en/core/recipes/ydb-sdk/auth-access-token.md",
            "ydb/docs/en/core/recipes/ydb-sdk/vector-search.md",
            "ydb/docs/en/core/integrations/toc_p.yaml",
        ...
        "files": [
            ("ydb/docs/ru/core/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/toc_i.yaml", "main"),
            ("ydb/docs/ru/core/recipes/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ydb-sdk/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/reference/ydb-sdk/observability/logging/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/recipes/json-search/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/concepts/streaming-query/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/concepts/toc_i.yaml", "main"),
            ("ydb/docs/ru/core/dev/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/integrations/toc_p.yaml", "main"),
            ("ydb/docs/ru/core/integrations/toc_i.yaml", "main"),
            ("ydb/docs/ru/core/integrations/spring/toc-spring.yaml", "main"),
            ("ydb/docs/ru/core/integrations/sql-translation/toc-sql-translation.yaml", "main"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-access-token.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-anonymous.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-env.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-metadata.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-service-account.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/auth-static.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/balancing-prefer-local.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/balancing-prefer-location.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/balancing-random-choice.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/bulk-upsert.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/distributed-lock.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/init.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/retry.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/session-pool-limit.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/ttl.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/tx-control.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/upsert.md", "head"),
            ("ydb/docs/ru/core/recipes/ydb-sdk/vector-search.md", "head"),
            ("ydb/docs/ru/core/reference/ydb-sdk/coordination.md", "head"),
            ("ydb/docs/ru/core/reference/ydb-sdk/observability/logging/logging.md", "head"),
        ],
    },
}
