...
- **Translator** (`[models].translate`): `deepseek-v4-flash/latest` (override: `YDBDOC_MODEL_TRANSLATE` or full `gpt://<folder>/deepseek-v4-flash/latest`; rollback via fallbacks: `yandexgpt-5.1`).
