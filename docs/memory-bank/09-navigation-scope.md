...
| `orphan_toc_page` | [#46569](https://github.com/ydb-platform/ydb/pull/46569), [#47104](https://github.com/ydb-platform/ydb/pull/47104) ← [#41271](https://github.com/ydb-platform/ydb/pull/41271); redirect tombstone [#51703](https://github.com/ydb-platform/ydb/pull/51703) ← [#45949](https://github.com/ydb-platform/ydb/pull/45949) | §6.117 / §6.123 / §6.224 | `test_pr_46569_orphan_page_when_parent_not_wired`, `test_pr_41271_nav_merge_runs_when_both_ru_and_en_toc_changed`, `test_run_pr_translation_skips_redirect_tombstone_en`, `test_apply_orphan_toc_page_checks_exempts_redirect_tombstone` |
...
| Nav no-op counted as completeness gap → no PR | [#47091](https://github.com/ydb-platform/ydb/pull/47091) re-translate | §6.144 | `test_completeness_ok_when_navigation_noop` |
| YFM Title not found: stale ``index.md#sessions`` / inbound ``#ldap-auth-provider`` | [#48047](https://github.com/ydb-platform/ydb/pull/48047) / [#48792](https://github.com/ydb-platform/ydb/pull/48792) | §6.142 path repair + **§6.174** 1:1 href/anchor/inbound | `test_pr_48047_sessions_*`, `test_href_parity_*`, `test_inbound_fragment_catches_48792_hole` |
| mixed inline+block toc hides ``with.md`` | [#48009](https://github.com/ydb-platform/ydb/pull/48009) ← [#30237](https://github.com/ydb-platform/ydb/pull/30237) | §6.139 | `test_pr_48009_mixed_inline_block_toc_*`, `test_pr_48009_md_only_queues_select_toc_*`, `test_pr_48009_merge_adds_with_*` |
...
| section href+include skipped; absent EN toc missing pages | [#46446](https://github.com/ydb-platform/ydb/pull/46446) → [#48183](https://github.com/ydb-platform/ydb/pull/48183) | §6.155 | `test_merge_applies_scoped_include_when_section_href_differs_from_en_flat`, `test_pr_46446_absent_en_streaming_toc_queues_sibling_pages` |
| EN-absent toc sibling (debug.md) not queued with debug-logs | [#37673](https://github.com/ydb-platform/ydb/pull/37673) → [#50684](https://github.com/ydb-platform/ydb/pull/50684) | §6.192 | `test_pr_37673_queues_en_absent_toc_sibling_debug_md` |
